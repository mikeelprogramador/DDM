                ...
                <div class="card-body">
                    <form action="../controller/controller_admin.php?producto=actualizar&data=<?php echo $_GET['data'];  ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ofertas" name="ofertas_pro" value="<?php echo (Productos::detallesDelProducto(5, id::desencriptar($_GET['data']))); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="valor" class="form-label">Valor del producto</label>
                            <input type="text" class="form-control" id="valor" name="precio_pro" value="<?php echo (Productos::detallesDelProducto(7, id::desencriptar($_GET['data']))); ?>">
                        </div>
