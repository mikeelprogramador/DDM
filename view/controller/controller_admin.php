...
if(isset($_POST ['enviar'])){
  ...
  if(isset($_FILES['card-img']))$img  = CrearProducto::img(1,$_FILES['card-img']);//creado la imagen
  if( $img == "0" )header("location: ../adm/admin.php?menPro=img".$img."&seccion=seccion-ag-pro");//El formato de la imagen coincide
  if( $img == "1" )header("location: ../adm/admin.php?menPro=img".$img."&seccion=seccion-ag-pro");//El tamaño de la imagen no coincide
